...
Lithe Audio should publish or share the validated [lithe-speaker-network-check-plugin-v1.5.3.zip](lithe-speaker-network-check-plugin-v1.5.3.zip) as a plugin. The customer installs **Lithe Speaker Network Check** from the supplied plugin link, then selects **Try in chat**.
